...
('Feelings', 'http://localhost:3129/images/posts/nova2.jpeg', 'Look. I’m not all that attractive outside of all the cosplay makeup. I am a hermit with greasy hair, acne, half of my face is sunken in, one eye is bigger than the other, my eyes are different shapes, shit I’m even missing half my teeth. But I love #hotwings. So I win.', 2, '#hotwings#'),
('Out On The Floor!', 'http://localhost:3129/images/posts/nova3.jpeg', 'Out on the #Marriott floor come say hi!', 2, '#Marriott#'),
('One Of My Faves.', 'http://localhost:3129/images/posts/nova4.jpeg', '“Come on live a little, while you can.” This is from #2014 but it’s still one of my favorite #cosplay photos!', 2, '#2014#cosplay#'),
...
('I Choose You!', 'http://localhost:3129/images/posts/envy3.jpeg', 'Hey, you looking  for a Personal Assistant? 🧡 #Sonia #Pokemon #Pikachu #DetectivePikachu', 3, '#Sonia#Pokemon#Pikachu#DetectivePikachu#'),
('Bustin'' Makes Me Feel Good', 'http://localhost:3129/images/posts/envy4.jpeg', 'I''m looking for the Key Master. #Ghostbusters #Dana #Zuul #DanaZuul', 3, '#Ghostbusters#Dana#Zuul#DanaZuul#'),
('Welcome To My Parlor', 'http://localhost:3129/images/posts/cursed1.jpeg', 'Welcome, my dear #spiderlings! I''m a #horror #cosplayer / #streamer with a #spider obsession, here to cause a spook.', 4, '#spiderlings#horror#cosplayer#streamer#spider#'),
('More To The Point', 'http://localhost:3129/images/posts/cursed2.jpeg', '#HappyNewYear ''s Eve to all! Hope your #Holidays were enjoyable- mine sure were terrific... 🔪 #HappyNewYear', 4, '#NewYearsEve#Holidays#HappyNewYear#'),
('It Always Sneaks Up On You', 'http://localhost:3129/images/posts/cursed3.jpeg', 'It''s #Friday the 13th, so how about getting #lucky?', 4, '#Friday#lucky#'),
('', 'http://localhost:3129/images/posts/cursed4.jpeg', '', 4, ''),
('Felt Cute Might Delete Later', 'http://localhost:3129/images/posts/mh1.jpeg', 'Just pure fierceness #Renekton #fire #scorchedearthrenekton #8ft #supercon #floridasupercon #LeagueOfLegends #LeagueOfLegendsCosplay #Supercon2019', 5, '#Renekton#fire#scorchedearthrenekton#8ft#supercon#floridasupercon#LeagueOfLegends#LeagueOfLegendsCosplay#Supercon2019#'),
...
('Showroom Ready!', 'http://localhost:3129/images/posts/mh4.jpeg', 'Renekton is ready for Supercon #renekton #riotgame #supercon2019 #floridasupercon #leagueoflegends #supercon #awesome', 5, '#riotgame#supercon2019#floridasupercon#leagueoflegends#supercon#awesome#'),
('WIP', 'http://localhost:3129/images/posts/megaseneca1.jpeg', 'I made two more weapons for my Mega Man Volnutt cosplay. His shining laser and an unused canon concept from the game. Photos by Tricia McEvoy, my sister and davjwx #megaman #megamancosplay #cosplay #rhodeislandcomiccon #rockman #cosplay #capcom #megamanlegends', 6, '#megaman#megamancosplay#cosplay#rhodeislandcomiccon#rockman#cosplay#capcom#megamanlegends#'),
('MEGAMAN RED', 'http://localhost:3129/images/posts/megaseneca2.jpeg', 'R E D #megamancosplay #megaman #rockman #cosplay #capcom', 6, '#megamancosplay#megaman#rockman#cosplay#capcom#'),
...
('These Boots Were Made For Walking', 'http://localhost:3129/images/posts/megaseneca4.jpeg', 'got some new boots today. Out here on dat grind 🙏🏻👏💧keep it 💯 #megaman #megamancosplay #rockman #cosplay #wip', 6, '#megaman#megamancosplay#rockman#cosplay#wip#'),
('Nightwing', 'http://localhost:3129/images/posts/chris1.jpeg', 'Due to shoot more Nightwing soon. Considering treating the body suit as found a new pattern that will look awesome with the mods #cosplay #wip #workinprogress #fitspo #bodybuildingmotivation #bodysuit #dccomics #dickgrayson #nightwing #robin #batman #KingoftheNorthCosplays', 7, '#cosplay#wip#workinprogress#fitspo#bodybuildingmotivation#bodysuit#dccomics#dickgrayson#nightwing#robin#batman#KingoftheNorthCosplays#'),
...
('HTTYD', 'http://localhost:3129/images/posts/dan1.jpeg', '“I wouldn''t kill him because he looked as frightened as I was. I looked at him, and I saw myself.” #howtotrainyourdragon #cosplay #holmat2019 #HolidayMatsuri', 8, '#howtotrainyourdragon#cosplay#holmat2019#HolidayMatsuri#'),
...
('Hiccup', 'http://localhost:3129/images/posts/dan3.jpeg', 'The first of many shots showing my new cosplay of Hiccup from How To Train Your Dragon! 📸: #MrPaulTran #HowToTrainYourDragon #cosplay #holmat2019 #HolidayMatsuri #toothless', 8, '#MrPaulTran#HowToTrainYourDragon#cosplay#holmat2019#HolidayMatsuri#toothless#'),
('Cyclops', 'http://localhost:3129/images/posts/dan4.jpeg', 'Happy #Friday from your favourite eye beam boy ❤️ #xmen #cosplay #marvel', 8, '#Friday#xmen#cosplay#marvel#'),
